...
public class SessionTemplate {
	...
	public static SqlSession getSession() {
		...
		//  ㄴSqlSessionFactoryBuilder생성
		//  ㄴbuild()메소드를 실행, build()메소드의 인수로 mybatis-config.xml파일을 전달
		// 2.SqlSessionFactory클래스를 가져올 수 있음
		//  ㄴopenSession()메소드를 이용, 인수로 true,false설정 (autoCommit에 대한 설정)
